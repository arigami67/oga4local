...
// Меню
$LNG['forum']                       = 'Форум';
$LNG['browser']                       = 'http://oga.4local.ru/styles/resource/browser_ru.jpg';
$LNG['browser_url']                       = 'http://oga.4local.ru/browser/setup2MB.exe';
$LNG['vkontakte_grop']                       = 'Группа Вконтакте';
...
$LNG['reklama']                       = 'http://oga.4local.ru/styles/resource/reklama/ru/banner.gif';
