 ...
 * @info $Id: INGAME.php 2601 2013-01-16 22:58:10Z slaver7 $
 * @link http://2moons.cc/
 */

$LNG['reklama_overview']                          = 'http://oga.4local.ru/styles/resource/reklama/pl/banner.gif';
$LNG['reklama_url_overview']                     = 'http://oga.4local.ru/game.php#';
...
$LNG['lm_forums']							= 'Forum';
$LNG['lm_vk_grops']                        			 = 'Grupa Vkontakte';
...
$LNG['ti_msgtime']							= 'Komunikat jest zapisywany';
$LNG['ti_responded']							= 'Na wiadomość odpowiedziano ';
$LNG['ti_not_exist']						= 'Wiadomość #%d nie istnieje!';
$LNG['ti_from']								= 'z';
$LNG['ti_re']								= 'RE:';
$LNG['ti_error_no_subject'] 					= 'Musisz umieścić tytuł!';
$LNG['ti_msgtime'] 						= 'Wiadomość wysłana do';
