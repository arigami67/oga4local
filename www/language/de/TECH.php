 ...
 * @info $Id: TECH.php 2601 2013-01-16 22:58:10Z slaver7 $
 * @link http://2moons.cc/
 */
...
$LNG['shortNames'] = array (
	...
	221 => 'Korvette',
        ...
        223 => 'Kriegsschiff',
        224 => 'Zerstörer',
        225 => 'Kaiserliche Kriegsschiff',
        226 => 'Construction Drohne',
        299 => 'Flugzeugträger',
...
$LNG['shortDescription'] = array(
	...
	221 => 'Kleines Kriegsschiff an ihre Grenzen bewaffnet und dient in erster Linie zum Angriff, an Bord mitführen, 8 Laserkanonen und leistungsfähig genug für seine gobaritov Schilde machen es unbesiegbar in den Händen eines erfahrenen Piloten.',
        222 => 'Formidable Schiff steht auf der Verteidigung des Planeten, ist der Hauptunterschied die defensiven Fähigkeiten, durch die Reduzierung der Geschwindigkeit und Angriffskraft des Schiffes war ein großer Priorität in den Vorständen und Verteidigung.',
        223 => 'Perfekte Zerstörer der Galaxien, macht seine perfekte Balance Angriff, Verteidigung und Geschwindigkeit die erste Wahl für alle Liebhaber von Weltraumschlachten, versenden vollkommen wahr zu seinem Namen und in Angriff und Verteidigung.',
        224 => 'Destroyer Stolz der Menschheit, an den Zähnen mit Lasern bewaffnet, Ionen-, Plasma-und Raketenwerfern dieses Schiff ist mehr wie ein Rächer, dieses Schiff hat immer Ziele, die er sich nicht der Lage gewesen porizit seine Geschwindigkeit Porojan menschliche Vorstellungskraft und Rüstungen kann fast alles zu widerstehen existierte, beim Senden sie Handelsschiffe anzugreifen ist wichtig, sich daran zu erinnern, es nicht zu, ohne Backup verlassen.',
        225 => 'Kaiserliche Kriegsschiff weiter entwickelten dalneeyshee Zerstörer und ist nur für die Gegenwart Kaiser zur Verfügung.',
        226 => 'Construction Drohne ist eine Art universelle Roboter Baumeister, als ein großer Erbauer der Mond oder Planeten in schwierigen Bedingungen für die Entwicklung dient.',
        299 => 'Dieses riesige Schiff wurde entworfen, um verdammte Flotte näher an das Militär oder für andere Aktionen zu mobilisieren.',
