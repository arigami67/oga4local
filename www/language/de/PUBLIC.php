 ...
 * @info $Id: PUBLIC.php 2601 2013-01-16 22:58:10Z slaver7 $
 * @link http://2moons.cc/
 */
...
// Menu
$LNG['forum']						= 'Forum';
$LNG['browser']                       = 'http://oga.4local.ru/styles/resource/browser_de.jpg';
$LNG['browser_url']                       = 'http://oga.4local.ru/browser/setup2MB.exe';
$LNG['vkontakte_grop']                       = 'Gruppe Vkontakte';
...
$LNG['reklama']                       = 'http://oga.4local.ru/styles/resource/reklama/de/banner.gif';
$LNG['reklama_url']                       = 'http://oga.4local.ru/game.php#';
