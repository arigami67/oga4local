...
223 => 'Battleship',
224 => 'Destroyer',
225 => 'Imperial warship',
226 => 'Construction drone',
299 => 'USS',
...
221 => 'Small warship armed to their limits and serves mainly to attack, carrying on board 8 laser guns, and powerful enough for its gobaritov shields make it invincible in the hands of a skilled pilot.',
222 => 'Terrible ship standing on the defense of the planet, the main difference is the defensive capabilities, by reducing the speed and attack power of the ship was a huge priority in the boards and defense.',
223 => 'Perfect destroyer of galaxies, its perfect balance attack, defense and speed makes the number one choice of all lovers of space battles, the ship is perfectly true to its name and in attack and defense.',
224 => 'Destroyer pride of mankind, being armed to the teeth with lasers, ion, plasma and rocket launchers this ship is more like an avenger, this ship has always existed goals which he had not been able porizit his speed POROJAN Human Imagination and armor can withstand almost anything, when sending it to attack merchant ships is important to remember not to leave it without a cover.',
225 => 'Imperial warship destroyer is dalneeyshee more developed and is available only for the present Emperor.',
226 => 'Construction drone is a kind of universal robot builder who serves as a great builder of the moon or planet in difficult conditions for development.',
299 => 'This is fucking huge vessel designed to mobilize the fleet closer to the war or for any other action.',
