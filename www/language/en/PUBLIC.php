...
// 2Moons - Copyright (C) 2010-2012 J㬠Kropke
...
// Menu
$LNG['forum']						= 'Forum';
$LNG['browser']                       = 'http://oga.4local.ru/styles/resource/browser_en.jpg';
$LNG['browser_url']                       = 'http://oga.4local.ru/browser/setup2MB.exe';
$LNG['vkontakte_grop']                       = 'Group Vkontakte';
...
$LNG['reklama']                       = 'http://oga.4local.ru/styles/resource/reklama/en/banner.gif';
