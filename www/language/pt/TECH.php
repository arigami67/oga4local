...
$LNG['shortNames'] = array (
	...
	223 => 'Battleship',
	224 => 'Destroyer',
	225 => 'Navio de guerra imperial',
	226 => 'Zangão construção',
	299 => 'USS',
...
$LNG['shortDescription'] = array(
	...
	221 => 'Pequeno navio de guerra armado até os seus limites e serve principalmente para o ataque, levando a bordo oito armas laser, e poderoso o suficiente para seus escudos gobaritov tornar invencível nas mãos de um piloto experiente.',
	222 => 'Pé navio Péssimo na defesa do planeta, a principal diferença é a capacidade defensiva, reduzindo a velocidade e poder de ataque do navio era uma grande prioridade em conselhos de administração e de defesa.',
	223 => 'Destruidor perfeito de galáxias, seu ataque perfeito equilíbrio, defesa e velocidade faz a escolha número um de todos os amantes de batalhas espaciais, o navio é perfeitamente fiel ao seu nome e no ataque e defesa.',
	224 => 'Orgulho destruidor "da humanidade, sendo armados até os dentes com lasers, íons, plasma e foguetes lançadores este navio é mais como um vingador, este navio sempre existiu metas que ele não tinha sido porizit capazes sua velocidade Imaginação POROJAN Humano e armadura pode resistir quase nada, quando enviá-lo para atacar navios mercantes é importante lembrar de não deixá-lo sem uma tampa.',
	225 => 'Destruidor navio de guerra imperial é dalneeyshee mais desenvolvido e está disponível apenas para o Imperador presente.',
	226 => 'Zangão construção é uma espécie de universal construtor robô que serve como um grande construtor da Lua ou planeta em condições difíceis para o desenvolvimento.',
	299 => 'Este é foda navio enorme destinada a mobilizar a frota mais perto da guerra ou para qualquer outra ação.',
