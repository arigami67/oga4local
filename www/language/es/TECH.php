...
$LNG['shortNames'] = array (
	...
	221 => 'Corvette',
        ...
        223 => 'Battleship',
        224 => 'Destructor',
        225 => 'Imperial buque de guerra',
        226 => 'Construcción drone',
        299 => 'USS',
...
221 => 'Pequeño barco de guerra armado hasta sus límites y sirve principalmente para atacar, llevando a bordo armas láser 8, y lo suficientemente potente como para sus escudos gobaritov hacerlo invencible en las manos de un piloto experto.',
222 => 'Standing barco terrible en la defensa del planeta, la principal diferencia es la capacidad defensiva, al reducir la velocidad y el poder de ataque de la nave era una gran prioridad en las juntas y la defensa.',
223 => 'Destructor perfecto de las galaxias, su ataque perfecto equilibrio, defensa y velocidad hace que la elección número uno de todos los amantes de batallas espaciales, la nave es perfectamente fiel a su nombre y en el ataque y la defensa.',
224 => 'Orgullo destructor de la humanidad, está armado hasta los dientes con láser, iones, plasma y lanzacohetes este barco es más como un vengador, este barco siempre ha existido metas que él no había sido porizit capaz su velocidad Imaginación POROJAN Humanos y la armadura puede soportar casi nada, al enviar a atacar a los barcos mercantes es importante recordar que no debe dejar sin cubrir.',
225 => 'Destructor buque de guerra imperial es dalneeyshee más desarrollado y está disponible sólo para el actual Emperador.',
226 => 'Zumbido de la construcción es una especie de robot constructor universal, que sirve como un gran constructor de la luna o un planeta en condiciones difíciles para el desarrollo.',
299 => 'Esto es jodidamente enorme nave diseñada para movilizar la flota más cerca de la guerra o para cualquier otra acción.',
