 ...
 * @info $Id: class.ShowFleetStep1Page.php 2603 2013-01-18 11:31:33Z slaver7 $
 * @link http://2moons.cc/
 */
...
class ShowFleetStep1Page extends AbstractPage
{
	...
	function checkTarget()
	{
		...
		if ($TargetPlanet != Config::get('max_planets') + 1) {
			...
			if ($activeExpedition >= FleetFunctions::getExpeditionLimit($USER) * 2)
			{
